...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "COLOR5_B" -parent ${Page_0}
  ipgui::add_param $IPINST -name "COLOR5_G" -parent ${Page_0}
  ipgui::add_param $IPINST -name "COLOR5_R" -parent ${Page_0}
  ipgui::add_param $IPINST -name "COLOR6_B" -parent ${Page_0}
  ipgui::add_param $IPINST -name "COLOR6_G" -parent ${Page_0}
  ipgui::add_param $IPINST -name "COLOR6_R" -parent ${Page_0}
...
proc update_PARAM_VALUE.COLOR5_B { PARAM_VALUE.COLOR5_B } {
	# Procedure called to update COLOR5_B when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.COLOR5_B { PARAM_VALUE.COLOR5_B } {
	# Procedure called to validate COLOR5_B
	return true
}

proc update_PARAM_VALUE.COLOR5_G { PARAM_VALUE.COLOR5_G } {
	# Procedure called to update COLOR5_G when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.COLOR5_G { PARAM_VALUE.COLOR5_G } {
	# Procedure called to validate COLOR5_G
	return true
}

proc update_PARAM_VALUE.COLOR5_R { PARAM_VALUE.COLOR5_R } {
	# Procedure called to update COLOR5_R when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.COLOR5_R { PARAM_VALUE.COLOR5_R } {
	# Procedure called to validate COLOR5_R
	return true
}

proc update_PARAM_VALUE.COLOR6_B { PARAM_VALUE.COLOR6_B } {
	# Procedure called to update COLOR6_B when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.COLOR6_B { PARAM_VALUE.COLOR6_B } {
	# Procedure called to validate COLOR6_B
	return true
}

proc update_PARAM_VALUE.COLOR6_G { PARAM_VALUE.COLOR6_G } {
	# Procedure called to update COLOR6_G when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.COLOR6_G { PARAM_VALUE.COLOR6_G } {
	# Procedure called to validate COLOR6_G
	return true
}

proc update_PARAM_VALUE.COLOR6_R { PARAM_VALUE.COLOR6_R } {
	# Procedure called to update COLOR6_R when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.COLOR6_R { PARAM_VALUE.COLOR6_R } {
	# Procedure called to validate COLOR6_R
	return true
}
...
proc update_MODELPARAM_VALUE.COLOR5_R { MODELPARAM_VALUE.COLOR5_R PARAM_VALUE.COLOR5_R } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.COLOR5_R}] ${MODELPARAM_VALUE.COLOR5_R}
}

proc update_MODELPARAM_VALUE.COLOR5_G { MODELPARAM_VALUE.COLOR5_G PARAM_VALUE.COLOR5_G } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.COLOR5_G}] ${MODELPARAM_VALUE.COLOR5_G}
}

proc update_MODELPARAM_VALUE.COLOR5_B { MODELPARAM_VALUE.COLOR5_B PARAM_VALUE.COLOR5_B } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.COLOR5_B}] ${MODELPARAM_VALUE.COLOR5_B}
}

proc update_MODELPARAM_VALUE.COLOR6_R { MODELPARAM_VALUE.COLOR6_R PARAM_VALUE.COLOR6_R } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.COLOR6_R}] ${MODELPARAM_VALUE.COLOR6_R}
}

proc update_MODELPARAM_VALUE.COLOR6_G { MODELPARAM_VALUE.COLOR6_G PARAM_VALUE.COLOR6_G } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.COLOR6_G}] ${MODELPARAM_VALUE.COLOR6_G}
}

proc update_MODELPARAM_VALUE.COLOR6_B { MODELPARAM_VALUE.COLOR6_B PARAM_VALUE.COLOR6_B } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.COLOR6_B}] ${MODELPARAM_VALUE.COLOR6_B}
}
